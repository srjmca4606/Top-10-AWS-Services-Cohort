# 👀 Day 11 — 🏆 YOUR COMPLETION CERTIFICATE + Extra Resume Points !
...
Then claim your **completion certificate** and post your entire 10-day journey on LinkedIn with all your screenshots. You did it! 🎉
...
|---|-------|
| 👀 | Cost Optimization's |
| ❓ | AWS High Package Job's | https://www.clouddevopshub.com/s/pages/jobs 
| ☁️ | Update Resume with AWS Services for High Package |
...
Step 4: Download your 
         "AWS Cloud Cohort — 10-Day Completion Certificate"
...
## 🗺️ Your 55 Day's Multi Cloud + DevOps with AI Roadmap
## 100% live & 100% interactive 
...
👨‍💻 @Vikas Ratnawat ( PwC |Ex Microsoft MVP)
